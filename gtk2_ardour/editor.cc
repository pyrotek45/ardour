...
Editor::Editor ()
	...
	, _bottom_pane_press_position (0.0f)
	, _bottom_pane_snap_pending (false)
{
	...
	/* click-to-reopen: detect clicks on collapsed divider to reopen panel */
	content_bottom_pane.signal_button_press_event().connect (
		sigc::mem_fun (*this, &Editor::bottom_pane_button_press), false);
	content_bottom_pane.signal_button_release_event().connect (
		sigc::mem_fun (*this, &Editor::bottom_pane_button_release), false);
